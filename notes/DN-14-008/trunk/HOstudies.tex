	...
	\subsection{Studies on detection efficiency of prompt muons using 2012 data}
		...
		\label{thesectionhere}
			...
			\begin{figure}[htbp]
				...
				\caption{Left: In the $\eta$-$\varphi$ plane, the red rectangles are showing the regions where HO is insensitive due to the supporting material or electrical issues \cite{JINST}. Right: In red
			...
			These muons are uniformly distributed in $\eta-\varphi$ due to the insensitive areas between the tiles.
