...
\label{sec:HOstudies}
	...
	\subsection{Studies on detection efficiency of prompt muons using 2012 data}
		...
		\label{thesectionhere}
			...
			With these results the safety margins in the study of the 2012 data are chosen to $\Delta\eta = 0.04$\,rad and $\Delta\varphi = 0.017$\,rad.
			...
			\begin{table*}[htbH]
				\begin{center}
					...
					\end{tabular}
				\end{center}
				\caption{Cut flow of the analyzed muons from the 2012 data.}
				\label{CutFlow}
			\end{table*}
