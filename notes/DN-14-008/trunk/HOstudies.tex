\section{Studies with the Hadron Outer Calorimeter}
	...
	\subsection{Studies on detection efficiency of prompt muons using 2012 data}
		...
		\label{thesectionhere}
			...
			In \cite{CMS-PAS-MUO-10-002} and \cite{CMS-PAS-MUO-10-004} all requirements on muons to be a tight muon are given.
			...
			Therefore it is helpful to reject those muons by defining safety margins at the edges of the panels as it is shown on the right hand side in figure \ref{fig:simhits_in_acceptance}.
			...
			With all these considerations 1.222.503 events with exactly one muon could be selected for the analysis (CutFlow).
