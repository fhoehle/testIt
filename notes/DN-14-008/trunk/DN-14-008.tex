...
\RCS$Id: DN-14-008.tex 249724 2014-07-04 13:41:10Z erdogan $
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
...
\title{A possible extension of the barrel muon trigger for the CMS experiment at HL-LHC: Muon Track fast Tag (MTT)}
...
\author[neu]{Erik Dietz-Laursonn}
...
% (3) No curly braces {}.
\hypersetup{%
pdfauthor={Yusuf Erdogan, Andreas  Kuensken, Oliver Pooth, Florian Scheuch},%
pdftitle={A possible extension of the barrel muon trigger for the CMS experiment at HL-LHC: Muon Track fast Tag (MTT)},%
pdfsubject={CMS},%
pdfkeywords={CMS, detector, upgrade, muon, trigger, HL-LHC, MTT, SiPM, prototype, hardware, electronics, ghost, barrel}}
...
\input{intro.tex}
\input{HOintro.tex}
\input{hoSipmUpgrade.tex}
\input{HOstudies.tex}
\input{ghosts.tex}
\input{triggerlink.tex}
