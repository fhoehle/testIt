...
% (3) No curly braces {}.
\hypersetup{%
pdfauthor={Yusuf Erdogan, Andreas K\"unsken, Oliver Pooth, Florian Scheuch},%
pdftitle={A new trigger concept for muons in the barrel region of the CMS experiment: Muon Track fast Tag},%
pdfsubject={CMS},%
pdfkeywords={CMS, detector, upgrade, muon}}
...
\bibliography{auto_generated,hoSipmUpgrade,HOstudies,MTTsimulation}   % will be created by the tdr script.
