...
\input{prototypemodules_hardware.tex}
\input{prototypemodules_software.tex}
\input{FEelectronics.tex}
\input{sipm.tex}
\input{ghosts.tex}
...
\bibliography{auto_generated,hoSipmUpgrade}   % will be created by the tdr script.
\bibliography{auto_generated,HOstudies}
\bibliography{auto_generated,MTTsimulation}
